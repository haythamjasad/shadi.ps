...
// Use site logo from public assets.
    ...
    ">
      ...
      ">
        ...
        <div class="brand-section" style="
          ...
          gap: 14px;
        ">
          <img src="${logoImage}" alt="Shadi Store Logo" style="
            width: 52px;
            height: 52px;
            border-radius: 10px;
      ...
      ">
        ...
        ">
          ...
          ">From</h3>
          <div style="color: #1d1d1f; font-size: 11px; line-height: 1.5;">
            <div style="font-weight: 600; margin-bottom: 4px;">Shadi Store</div>
            <div style="color: #86868b; margin-bottom: 2px;">Palestine</div>
            <div style="color: #86868b; margin-bottom: 2px;">info@shadi.ps</div>
            <div style="color: #86868b;">+972 56 811 4114</div>
          </div>
        </div>
      </div>
      ...
      ">
        <h3 style="
          ...
          margin: 0 0 8px 0;
          letter-spacing: -0.2px;
        ">Thank you for your order at Shadi Store!</h3>
        <p style="
          font-size: 10px;
          color: #86868b;
          margin: 0;
...
export const downloadOrderReceipt = async (order) => {
  try {
    ...
    await generatePdfFromElement('temp-receipt-container', `Shadi-Store-Invoice-${order.orderId}`);
