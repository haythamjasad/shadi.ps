...
function generateMetaTags(product, url) {
  const metaDescription = product.description
    ...
    : `Buy ${product.name} online at Shadi Store`;

  const title = `${product.name} | Shadi Store - Premium Stationery`;
  ...
  return `
    ...
    <meta property="og:site_name" content="Shadi Store - Premium Stationery">
    ...
    <meta name="twitter:site" content="@ShadiStore">
