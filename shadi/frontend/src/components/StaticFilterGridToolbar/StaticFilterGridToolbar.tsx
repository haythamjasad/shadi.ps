...
const StaticFilterGridToolbar: FC<StaticFilterGridToolbarProps> = ({
  refetch,
  setTextFilter,
  statusFilter,
  setStatusFilter,
  ...
  const isSelected = (item: StatusFilter) => statusFilter === item;
  const selectOne = (item: StatusFilter) => {
...
export default StaticFilterGridToolbar;
