...
const getEmailFunctionToken = () => (process.env.REACT_APP_EMAIL_FUNCTION_TOKEN || '').trim();
...
const isEmailEnabled = () => {
  ...
  const functionToken = getEmailFunctionToken();
  if (!functionToken) {
    console.log('❌ Email functionality disabled: missing REACT_APP_EMAIL_FUNCTION_TOKEN');
    return false;
  }
  ...
  console.log('- REACT_APP_EMAIL_FUNCTION_TOKEN exists:', !!functionToken);
...
const sendViaApiEndpoint = async (emailData) => {
  try {
    const functionToken = getEmailFunctionToken();
    if (!functionToken) {
      throw new Error('Missing REACT_APP_EMAIL_FUNCTION_TOKEN');
    }
    ...
    const formattedFrom = fromEmail.includes('<') ? fromEmail : `Shadi Store <${fromEmail}>`;
...
const sendOrderConfirmationEmail = async (order, user) => {
  ...
  try {
    ...
    const emailData = {
      to: user.email,
      subject: `Shadi Store - Order Confirmation #${order.orderId}`,
      body: emailBody,
    };
              ...
              <tr>
                <td style="padding: 32px 40px; border-bottom: 1px solid #e5e7eb;">
                  <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                    <tr>
                      <td align="left">
                        <h1 style="margin: 0; font-size: 24px; font-weight: 600; color: #111827; letter-spacing: -0.5px;">Shadi Store</h1>
              ...
              <tr>
                <td style="padding: 32px 40px; background-color: #f9fafb; border-top: 1px solid #e5e7eb; text-align: center;">
                  <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                    <tr>
                      <td style="text-align: center;">
                        <p style="margin: 0 0 8px 0; font-size: 14px; font-weight: 600; color: #111827;">Shadi Store</p>
                        ...
                        <p style="margin: 0; font-size: 12px; color: #9ca3af;">
                          © ${new Date().getFullYear()} Shadi Store. All Rights Reserved.
                        </p>
                      </td>
                    </tr>
                  </table>
              ...
              <tr>
                <td style="padding: 40px 40px 32px 40px;">
                  ...
                  <div style="text-align: center; margin-bottom: 32px;">
                    <a href="${shipmentInfo.trackingUrl}" target="_blank" style="display: inline-block; background-color: #f89c1c; color: #1f1f27; font-size: 14px; font-weight: 700; text-decoration: none; padding: 12px 24px; border-radius: 6px;">Track Your Package</a>
                  </div>
                  ` : ''}
                  ...
                  <div style="background-color: #f9fafb; border: 1px solid #e5e7eb; border-radius: 6px; padding: 20px; text-align: center;">
                    ...
                    <a href="mailto:${featureConfig.email.supportEmail}" style="display: inline-block; background-color: #f89c1c; color: #1f1f27; font-size: 14px; font-weight: 700; text-decoration: none; padding: 10px 20px; border-radius: 6px;">Contact Support</a>
                  </div>
                </td>
              </tr>
...
const sendMagicLinkEmail = async (email, magicLink) => {
  ...
  try {
    ...
    const emailData = {
      to: email,
      subject: 'Sign in to Shadi Store - Your Magic Link',
      body: emailBody,
    };
...
<head>
  ...
  <meta name="format-detection" content="telephone=no, date=no, address=no, email=no">
  <meta name="x-apple-disable-message-reformatting">
  <title>Sign in to Shadi Store</title>
  <style type="text/css">
    body, table, td {
      font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Helvetica Neue', Arial, sans-serif !important;
    }
                  ...
                  <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                    <tr>
                      <td style="text-align: center;">
                        ...
                        <p style="margin: 0 0 24px 0; color: #6b7280; font-size: 15px; line-height: 1.5;">Click the button below to securely sign in to your Shadi Store account.</p>
                        ...
                        <div style="text-align: center; margin-bottom: 24px;">
                          <a href="${magicLink}" target="_blank" style="display: inline-block; background-color: #f89c1c; color: #1f1f27; font-size: 16px; font-weight: 700; text-decoration: none; padding: 14px 32px; border-radius: 6px; margin: 0 auto;">Sign In to Shadi Store</a>
                        </div>
